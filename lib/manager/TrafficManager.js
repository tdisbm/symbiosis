...
var TrafficManager = function(map) {
    ...
    this.rooms = {};
    this.dataStorage = new utils.dataStorage(this);
    ...
    this.io.use(function(socket, next) {
        ...
        socket.onevent = function (packet) {
            $this.dataStorage.setData(query, packet.data);
        };
...
TrafficManager.prototype.setRoom = function(query) {
    var identifier = this.handshake["identifier"];
    var room = this.handshake["room"];
...
TrafficManager.prototype.refresh = function(query) {
    var identifier = this.handshake["identifier"];
    var room = this.handshake["room"];
